...
Application::Application()
{
	...
	const char* fragment_shader_src = R"(
		...
		void main()
		{
			gl_FragColor = vec4(v_color * u_brightness, 1.0);
		}
	)";
	...
	m_uniform_brightness = glGetUniformLocation(m_program, "u_brightness");
...
void Application::Draw(float time)
{
	...
	float multiplier = 1.0 + sin(time);
	glUniform1f(m_uniform_brightness, multiplier);
